...
(window.averta = {}),
        ...
        (p.getDirection = function (new_x, new_y) {
                ...
                if (swipe.enabled && !($(event.target).closest(swipe.noSwipeSelector, swipe.$element).length > 0)) {
                    ...
                    if (!(swipe.touchStarted || (isTouch && swipe.start_time && "mousedown" === event.type && new Date().getTime() - swipe.start_time < 600))) {
                        ...
                        (swipe.start_x = point.pageX),
                            ...
                            $(document).on(ev_end, { target: swipe }, swipe.__touchEnd).on(ev_move, { target: swipe }, swipe.__touchMove).on(ev_cancel, { target: swipe }, swipe.__touchCancel);
            ...
            (p.__touchEnd = function (event) {
                ...
                isTouch || jqevt.preventDefault(),
                    ...
                    $(document).off(ev_end, swipe.__touchEnd).off(ev_move, swipe.__touchMove).off(ev_cancel, swipe.__touchCancel),
    ...
    (function ($) {
        ...
        (Polyfill.defaultOptions = { forcePolyfill: !1, selector: "*", listenOn: ["click", "dblclick", "mousedown", "mouseup"], pointerEventsNoneClass: null, pointerEventsAllClass: null, eventNamespace: "pointer-events-polyfill" }),
            ...
            (Polyfill.prototype.isClickThrough = function ($el) {
                ...
                return 0 === $el.length || "all" === elPointerEventsCss || $el.is(":root") || $el.hasClass(this.options.pointerEventsAllClass)
                    ? !1
                    : "none" === elPointerEventsCss || $el.hasClass(this.options.pointerEventsNoneClass) || this.isClickThrough($el.parent())
                    ? !0
                    : !1;
            }),
    ...
    (function () {
        "use strict";
        var _options = { bouncing: !0, snapping: !1, snapsize: null, friction: 0.05, outFriction: 0.05, outAcceleration: 0.09, minValidDist: 0.3, snappingMinSpeed: 2, paging: !1, endless: !1, maxSpeed: 160 },
    ...
    (function ($, window) {
        ...
        (p.addLayer = function (layer) {
            ...
            (p.create = function () {
                _super.create.apply(this, arguments), this.slider.api.addEventListener(MSSliderEvent.CHANGE_START, this.checkLayers.on(this));
            }),
    ...
    (function ($, window) {
        ...
        (p.setupLayerController = function () {
            (this.layerController = new MSOverlayLayerController(this)),
                this.slider.api.addEventListener(MSSliderEvent.RESIZE, this.setSize.on(this)),
                this.slider.api.addEventListener(MSSliderEvent.CHANGE_START, this.setSize.on(this)),
                this.setSize();
        }),
            (p.setSize = function () {
            ...
            (p.create = function () {
                this.layerController.create(),
                    ...
                    window.pointerEventsPolyfill && window.pointerEventsPolyfill({ selector: "#" + this.slider.$element.attr("id") + " .ms-overlay-layers", forcePolyfill: !1 });
            }),
    ...
    (function ($) {
        window.MSLayerElement = function () {
            (this.start_anim = { name: "fade", duration: 1e3, ease: "linear", delay: 0 }),
        ...
        (p.setStartAnim = function (anim) {
            ...
            (p.create = function () {
                ...
                $.extend(this.end_anim, this._parseEff(this.end_anim.name)),
                    ...
                    this.masked &&
                        ...
                        this.link ? (this.link.wrap(this.$mask), (this.$mask = this.link.parent())) : (this.$element.wrap(this.$mask), (this.$mask = this.$element.parent())),
                        this.maskWidth && this.$mask.width(this.maskWidth),
                        this.maskHeight && (this.$mask.height(this.maskHeight), -1 === this.__cssConfig.indexOf("height") && this.__cssConfig.push("height")));
                ...
                (this.parallax = this.$element.data("parallax")),
                    null != this.parallax &&
                        ...
                        this.masked
                            ? (this.$mask.wrap(this.$parallaxElement), (this.$parallaxElement = this.$mask.parent()))
                            : this.link
                            ? (this.link.wrap(this.$parallaxElement), (this.$parallaxElement = this.link.parent()))
                            : (this.$element.wrap(this.$parallaxElement), (this.$parallaxElement = this.$element.parent())),
                        (this._lastParaX = 0),
                        (this._lastParaY = 0),
                        (this._paraX = 0),
                        (this._paraY = 0),
            ...
            (p.init = function () {
                ...
                for (var i = 0, l = this.__cssConfig.length; l > i; i++) {
                    ...
                    (this.layerOrigin &&
                        (("top" === key && -1 === this.layerOrigin.indexOf("t") && -1 === this.layerOrigin.indexOf("m")) ||
                            ("bottom" === key && -1 === this.layerOrigin.indexOf("b")) ||
                            ("left" === key && -1 === this.layerOrigin.indexOf("l") && -1 === this.layerOrigin.indexOf("c")) ||
                        ...
                        (isPosition = this._isPosition(key)),
                            ...
                            (this.resizable || isPosition) &&
                                ("top" === key && this.middleAlign
                                    ? (($layerEle[0].style.top = "0px"), (this.baseHeight = $layerEle.outerHeight(!1)), ($layerEle[0].style.top = this.baseStyle.top * factor + (height - this.baseHeight) / 2 + "px"))
                                    : "left" === key && this.centerAlign
                                    ? (($layerEle[0].style.left = "0px"), (this.baseWidth = $layerEle.outerWidth(!1)), ($layerEle[0].style.left = this.baseStyle.left * factor + (width - this.baseWidth) / 2 + "px"))
                                    : isPosition && this.masked
                                    ? ($layerEle[0].style[key] = this.baseStyle[key] * factor + "px")
                                    : isSize && (("width" === key && this.maskWidth) || ("height" === key && this.maskHeight))
                                    ? ($layerEle[0].style[key] = this.baseStyle[key] * factor + "px")
    ...
    (function ($) {
        ...
        (p._showTT = function () {
            this.show_cl &&
                ...
                this.hide_start && ((this.align = this._orgAlign), this._locateTT(), this.tt.css({ display: "block" }), (this._tween = CTween.animate(this.tt, 900, this.to, { ease: "easeOut" + this.ease })), (this.hide_start = !1)));
        }),
            (p._hideTT = function () {
                if (this.show_cl) {
                    this._tween && this._tween.stop(!0);
        ...
        (p.setupView = function () {
            ...
            (p.setup = function () {
                ...
                if ((this.view.create(startSlide), 0 === this.so.preload && this.view.slideList[0].loadImages(), (this.scroller = this.view.controller), this.so.wheel)) {
                    ...
                    (this.wheellistener = function (event) {
                        ...
                        $.browser.mozilla ? this.slider.$element[0].addEventListener("DOMMouseScroll", this.wheellistener) : this.slider.$element.on("mousewheel", this.wheellistener);
                }
            ...
            (p._destroy = function () {
                this._timer.reset(),
                    ...
                    this.view.destroy(),
                    (this.view = null),
                    this.so.wheel && ($.browser.mozilla ? this.slider.$element[0].removeEventListener("DOMMouseScroll", this.wheellistener) : this.slider.$element.off("mousewheel", this.wheellistener), (this.wheellistener = null)),
                    (this.so = null);
            }),
        ...
        (p.__setupSlides = function () {
            ...
            (p._setupSliderLayout = function () {
                ...
                "boxed" !== lo && "partialview" !== lo && (this.options.fullwidth = !0),
                    ...
                    ("fullscreen" === lo || "fullwidth" === lo || "autofill" === lo) && ($(window).on("resize", { that: this }, this._updateLayout), this._updateLayout()),
            ...
            (p.setHeight = function (value) {
                this.options.smoothHeight
                    ? (this.htween && (this.htween.reset ? this.htween.reset() : this.htween.stop(!0)), (this.htween = CTween.animate(this.slideController.view.$element, 500, { height: value }, { ease: "easeOutQuart" })))
            ...
            (p.destroy = function (insertMarkup) {
                ...
                var lo = this.options.layout;
                ("fullscreen" === lo || "fullwidth" === lo) && $(window).off("resize", this._updateLayout),
                    (this.view = null),
                    (this.slides = null),
                    (this.options = null),
    ...
    (function ($) {
        ...
        window.MSBasicView = function (options) {
            (this.options = { loop: !1, dir: "h", autoHeight: !1, spacing: 5, mouseSwipe: !0, swipe: !0, speed: 17, minSlideSpeed: 2, viewNum: 20, critMargin: 1 }),
                $.extend(this.options, options),
                ...
                (this.slideChanged = !1),
                (this.controller = new Controller(0, 0, { snapping: !0, snapsize: 100, paging: !0, snappingMinSpeed: this.options.minSlideSpeed, friction: (100 - 0.5 * this.options.speed) / 100, endless: this.loop })),
        ...
        (p.slideAction = function () {}),
            ...
            (p.checkHideUnder = function () {
                this.options.hideUnder &&
                    ((this.needsRealign = !this.options.insetTo && ("left" === this.options.align || "right" === this.options.align) && this.options.inset === !1), $(window).on("resize", { that: this }, this.onResize), this.onResize());
            }),
        ...
        (p.setup = function () {
            ...
            if (!this.options.insetTo && this.options.align) {
                ...
                this.options.inset
                    ...
                    : "top" === align
                    ? this.$element.detach().prependTo(this.slider.$element).css({ "margin-bottom": this.options.margin, position: "relative" })
                    : "bottom" === align
                    ? this.$element.css({ "margin-top": this.options.margin, position: "relative" })
            ...
            (p.create = function () {
                _super.create.call(this),
                    (this.__translate_end = window._css3d ? " translateZ(0px)" : ""),
                    (this.controller = new Controller(0, 0, { snappingMinSpeed: 2, friction: (100 - 0.5 * this.options.speed) / 100 })),
                ...
                this.options.wheel &&
                    ...
                    $.browser.mozilla ? this.$element[0].addEventListener("DOMMouseScroll", this.wheellistener) : this.$element.on("mousewheel", this.wheellistener)),
            ...
            (p._hMove = function (controller, value) {
                return (
                    (this.__contPos = value), window._cssanim ? void (this.$thumbscont[0].style[window._jcsspfx + "Transform"] = "translateX(" + -value + "px)" + this.__translate_end) : void (this.$thumbscont[0].style.left = -value + "px")
                );
            }),
            (p._vMove = function (controller, value) {
                return (
                    (this.__contPos = value), window._cssanim ? void (this.$thumbscont[0].style[window._jcsspfx + "Transform"] = "translateY(" + -value + "px)" + this.__translate_end) : void (this.$thumbscont[0].style.top = -value + "px")
                );
            }),
            (p.setupSwipe = function () {
            ...
            (p.destroy = function () {
                _super.destroy(),
                    this.options.wheel && ($.browser.mozilla ? this.$element[0].removeEventListener("DOMMouseScroll", this.wheellistener) : this.$element.off("mousewheel", this.wheellistener), (this.wheellistener = null)),
                    $(window).off("resize", this.resize_listener),
                    this.$element.remove(),
        ...
        (p.setup = function () {
            if (
                ...
                this.options.inset
                    ? this.$element.css(align, this.options.margin)
                    : "top" === align
                    ? this.$element.prependTo(this.slider.$element).css({ "margin-bottom": this.options.margin, position: "relative" })
                    : "bottom" === align
                    ? this.$element.css({ "margin-top": this.options.margin, position: "relative" })
                    : (this.slider.api.addEventListener(MSSliderEvent.RESERVED_SPACE_CHANGE, this.align, this), this.align());
            }
    ...
    (function ($) {
        window.MSGallery = function (id, slider) {
            (this.id = id),
                ...
                slider.control("thumblist", { insertTo: this.thumbcont, autohide: !1, dir: "h" }),
