...
const ddaccordion = {
	...
	init: function (config) {
		...
		style.type = 'text/css';
		style.innerHTML = '.' + config.contentclass + '{display: none}\n' +
		...
		jQuery(document).ready(function ($) {
			...
			$headers.on("evt_accordion", function (e, isdirectclick) { //assign CUSTOM event handler that expands/ contacts a header
			...
			$headers.on(config.revealtype, function () {
			...
			$(window).on('visibilitychange', function () { //clean up and persist on page unload
				$headers.off()
				var expandedindices = []
				$subcontents.filter(':visible').each(function (_index) { //get indices of expanded headers
